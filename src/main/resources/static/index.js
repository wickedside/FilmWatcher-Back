...
async function openModal(id) {
  ...
  modalEl.innerHTML = `
    <div class="modal__card">
      <img class="modal__movie-backdrop" src="${respData.posterUrl}" alt=""></img>
      <h2>
      ...
      <button class="modal__button-goto"><a href="moviePage?id=${id}" class="modal__button-details">Перейти к фильму</a></button>
